...
namespace RestClientDotNet.Abstractions
{
    public interface IResponseProcessorFactory
    {
        ...
        void Dispose();
        IRestResponse<TReturn> CreateResponse<TReturn>(IRestHeadersCollection headers, int statusCode, IResponseProcessor responseProcessor, Uri baseUri, Uri resource, HttpVerb httpVerb);
    }
}