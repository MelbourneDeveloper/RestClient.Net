...
namespace RestClientDotNet.Abstractions
{
    public interface IResponseProcessorFactory
    {
        ...
        void Dispose();
        RestResponse<TReturn> CreateResponse<TReturn>(IRestHeadersCollection headers, int statusCode, IResponseProcessor responseProcessor, Uri baseUri, Uri resource, HttpVerb httpVerb, TReturn body);
    }
}